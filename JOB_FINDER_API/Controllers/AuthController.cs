...
{   
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterRequest request)
        {
            ...
            {
                return StatusCode(500, $"error register: {ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> RequestForgotPassword([FromBody] ForgotPasswordRequestDto dto)
        {
            ...
            _emailService.SendEmail(dto.Email, "Password reset verification code", $"Your verification code is: {code}", false);
