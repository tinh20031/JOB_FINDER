<<<<<<<< HEAD:JOB_FINDER_API/Migrations/20250525074857_FixCandidateSkillMapping.cs
﻿using System;
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageJob = table.Column<string>(type: "nvarchar(max)", nullable: true),
    ...
    public partial class update : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 5, 23, 14, 26, 59, 687, DateTimeKind.Utc).AddTicks(6939), "Candidate", new DateTime(2025, 5, 23, 14, 26, 59, 687, DateTimeKind.Utc).AddTicks(6961) },
                    { 2, new DateTime(2025, 5, 23, 14, 26, 59, 687, DateTimeKind.Utc).AddTicks(6986), "Company", new DateTime(2025, 5, 23, 14, 26, 59, 687, DateTimeKind.Utc).AddTicks(6986) },
                    { 3, new DateTime(2025, 5, 23, 14, 26, 59, 687, DateTimeKind.Utc).AddTicks(6987), "Admin", new DateTime(2025, 5, 23, 14, 26, 59, 687, DateTimeKind.Utc).AddTicks(6988) }
                });
...
>>>>>>>> 323abc6 (cache):JOB_FINDER_API/Migrations/20250523142700_update.cs
