    ...
    public partial class innitial1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 5, 25, 15, 12, 41, 472, DateTimeKind.Utc).AddTicks(7294), "Candidate", new DateTime(2025, 5, 25, 15, 12, 41, 472, DateTimeKind.Utc).AddTicks(7299) },
                    { 2, new DateTime(2025, 5, 25, 15, 12, 41, 472, DateTimeKind.Utc).AddTicks(7304), "Company", new DateTime(2025, 5, 25, 15, 12, 41, 472, DateTimeKind.Utc).AddTicks(7304) },
                    { 3, new DateTime(2025, 5, 25, 15, 12, 41, 472, DateTimeKind.Utc).AddTicks(7306), "Admin", new DateTime(2025, 5, 25, 15, 12, 41, 472, DateTimeKind.Utc).AddTicks(7306) }
                });
