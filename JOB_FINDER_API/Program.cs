...
.AddCookie("External", options =>
{
    ...
    // Disable automatic redirects for API flow
...
.AddGoogle(options =>
{
    ...
    options.Events = new OAuthEvents
    {
        ...
        // This is crucial - handle redirect to ensure state parameter is properly maintained
...
{
    // Force HTTPS for OAuth endpoints on production
    if (context.Request.Host.Host.Contains("onrender.com") &&
...
app.UseForwardedHeaders(new ForwardedHeadersOptions
{
    ...
    // Nếu cần, có thể thêm:
    // KnownNetworks = { }, // Để chấp nhận mọi proxy
    // KnownProxies = { }
});
